<%-- 
    Document   : User_courseinfo
    Created on : 25 Jan, 2025, 11:17:38 AM
    Author     : VAIBHAV
--%>
...
<body>
    ...
    <%@include file="User_Header.jsp" %>
         ...
         try
        {
            ...
            String sql="select * from admin_coursecreation where AdminCourseCreat_ID='"+request.getParameter("cid")+"'";
         ...
         <div class="card">
            <div class="row">
                <!-- Image Section -->
                <div class="col-sm-6">
                    <img src="images/<%=result.getString("Uploadimage")%>" alt="Yoga Image" class="card-image img-fluid">
                </div>
                <!-- Content Section -->
                <div class="col-sm-6">
                    <div class="card-content">
                        <form action="course_booking" method="POST">
                            <input type="hidden" name="course_id" value="<%=result.getString("AdminCourseCreat_ID")%>"/>
                            <input type="hidden" name="price" value="<%=result.getString("Price")%>"/>
                        <h1><%=result.getString("Coursename")%></h1>
                        <br>
                        <p><strong>Trainer:</strong><%=result.getString("TrainerID")%></p>
                        ...
                        <p><strong>Location:</strong><%=result.getString("location")%></p>
