<%-- 
    Document   : Admin_cashEvent
    Created on : 16 Mar, 2025, 5:39:34 PM
    Author     : VAIBHAV
--%>
...
<body>
    ...
    <div class="container">
        <h2 class="table-title">Event Cash Payment</h2>
         ...
         try
        {
            ...
            String sql="select * from  user_eventpayment";
            ...
            <form action="user_eventpayment" method="post">
                 <td><%=result.getString("EPayment_ID")%></td>
