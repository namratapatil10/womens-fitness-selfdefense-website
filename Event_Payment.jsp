<%-- 
    Document   : Event_Payment
    Created on : 6 Mar, 2025, 8:58:47 AM
    Author     : VAIBHAV
--%>
...
<html>
   ...
   <form action="User_EventPayment" method="post">
         <script src="validation.js"></script>
            ...
            <button type="button" class="btn btn-outline-primary " onclick="showDiv('div1')" name="btnmethod" value="MPayment">Card</button>
             <button type="button" class="btn btn-outline-success" onclick="showDiv('div2')" name="btnmethod" value="MPayment">UPI</button>
              <button type="button" class="btn btn-outline-success" onclick="showDiv('div3')" name="btnmethod" value="MPayment">Cash</button>
             <br>
             <br>
            ...
            <lable>CVC</lable>
             ...
             <div class="button-container">
                   <a href="MyEvent.jsp" class="btn btn-primary">Payment</a>
             <br>
          ...
          <div class="jumbotron w-50"  id="div2"> 
            ...
            <br>
            <div class="button-container">
            <input type="submit" name="btn" value="Paym" class="btn btn-primary"/>
            <br>
            </div>
            </form>
          </div>
