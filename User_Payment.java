...
public class User_Payment extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
       ...
       String status=req.getParameter("txt_status");
        String paysubmit=req.getParameter("Pay");
       ...
       {
          String sql="insert into user_payment(FullN,Amou,PaymentD,ReceivedP,pendingP,Payments) values('"+fulln+"','"+Amop+"','"+date+"','"+Received+"','"+pending+"','"+status+"')";
         ...
         out.println(result);
          ...
          resp.setContentType("text/html;charset=UTF-8");
                    ...
                    out.println("location=' Admin_VIEW_CashPayment.jsp';");
                    out.println("</script>");
       }
    }
