<%-- 
    Document   : UserLogin
    Created on : 29 Dec, 2024, 8:44:11 PM
    Author     : VAIBHAV
--%>
...
body {
    ...
    font-family: Arial, sans-serif;
     background-image: url("images/imagefirst.jpeg");
    ...
    <div class="login-container">
        <div class="login-box">
            ...
            <form>
                ...
                <button type="submit" value="Login" name="btn_submit">Login</button>
                 <br>
                <br>
          <a href="User_Registrationform.jsp" class="d-block text-center mt-2">Sign up</a>
