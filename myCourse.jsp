<%-- 
    Document   : myCourse
    Created on : 27 Feb, 2025, 12:56:07 PM
    Author     : VAIBHAV
--%>
...
<html>
    ...
    <body>
         ...
         try
        {
            ...
            String sql="select * from course_booking inner join admin_coursecreation on course_booking.course_id=admin_coursecreation.AdminCourseCreat_ID where course_booking.user_id='"+session.getAttribute("user_id")+"'";
